...
var cardImg0 = new Image(); cardImg0.src= "_images/cardback.gif";
var cardImg1 = new Image(); cardImg1.src= "_images/jack.gif";
var cardImg2 = new Image(); cardImg2.src= "_images/queen.gif";
var cardImg3 = new Image(); cardImg3.src= "_images/king.gif";
...
function cardCreateNode() {
  ...
  if (this.rank == "J")
    tempNode.src = "_images/jack.gif";
  if (this.rank == "Q")
    tempNode.src = "_images/queen.gif";
  if (this.rank == "K")
    tempNode.src = "_images/king.gif";
